...
--SELECT * FROM SYS.MASTER_FILES SMF JOIN SYS.DATABASES SDB ON SMF.DATABASE_ID=SDB.DATABASE_ID WHERE SDB.NAME=@NOME AND SMF.TYPE_DESC='ROWS' AND SDB.STATE_DESC='ONLINE'
OPEN FILES_CURSOR
